  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/user-not-found' || error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
        ...
        newErrors.general = 'Failed to sign in. Please try again';
      }
      setErrors(newErrors);
    } finally {
      setLoading(false);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="frosted-glass" style={{
            ...
            {/* Email Field */}
            <div className="input-container" style={{ marginBottom: '1.5rem', textAlign: 'left' }}>
              <label 
                className="label"
                style={{
                  display: 'block',
        ...
        <button 
          onClick={handleSignIn}
            ...
            {/* Sign up Link */}
            <div className="sign-up-link-container" style={{
              marginTop: '2.5rem',
              color: '#666',
              fontSize: '1rem',
              fontFamily: "'Britti Sans Trial', Inter, sans-serif",
